...
export default function BadgeList({ badges, onRevoke, loading }) {
    const copyBadge = async (badge) => {
    ...
    if (!badges || badges.length === 0) {
        return (
            <div className="card text-center py-8">
                ...
                <p className="text-slate-400">No active Pawn Passes</p>
                <p className="text-sm text-slate-500 mt-1">Generate a Pawn Pass to give your AI agents verified credentials</p>
            </div>
        );
    }
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    <span className="font-medium text-white">Pawn Pass</span>
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => copyBadge(badge)}
                                title="Copy Pawn Pass"
                            >
